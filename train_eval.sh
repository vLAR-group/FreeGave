...
exp=pendulums
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.75 --fps 60
...
exp=robot
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.75 --fps 30
...
exp=Skating
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.65 --fps 20 --vel_start_time 0.35
...
exp=Truck
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.65 --fps 60
#python render.py -m $output/$exp --mode render --skip_train --fps 60
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val
...
output=output/GOPRO
exp=pen1
#python train_gui.py -s /path/to/data/ -m $output/$exp --max_time 0.70
#python render.py -m $output/$exp --mode render --skip_train
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val
...
exp=box
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.70
#python render.py -m $output/$exp --mode render --skip_train
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val

exp=mat
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.75
#python render.py -m $output/$exp --mode render --skip_train --fps 88
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val

exp=collision
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.73
#python render.py -m $output/$exp --mode render --skip_train
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val
#python render.py -m $output/$exp --mode original --skip_val --skip_test
...
exp=cube
#python train_gui.py -s /path/to/data/ -m $output/$exp --eval --is_blender --max_time 0.72
#python render.py -m $output/$exp --mode render --skip_train
#python metrics.py -m $output/$exp --s test
#python metrics.py -m $output/$exp --s val
